...
#slide[
	...
	#pause
	In order to determine the full angular state of a system we cannot use, i.e. $L_x$ and $L_y$#pause, but
	#v(5pt)
	$ [hat(L)_i, hat(bold(L))^2] = 0 $
][
	#pause
	The common basis of $hat(bold(L))^2$ and $hat(L)_z$ is represented as $|l m chevron.r$ and their action is 
